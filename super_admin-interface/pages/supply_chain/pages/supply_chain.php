...
<div class="supply-chain-grid grid-scrollbar-design">
        <div class="dashboard-item title grid-item-design">Supply-chain Management</div>

        <div class="supply-chain-item sc1 top-row grid-item-design">
            <div class="top">
                <div class="text">
                    <div class="name">Pending</div>
                    <div class="value">57,753</div>
                </div>
            ...
            <div class="dashboard-analytics">
                <span>+7%</span> minutes ago
            </div>
        </div>
        <div class="supply-chain-item sc2 top-row grid-item-design">
            <div class="top">
                <div class="text">
                    <div class="name">On-Process</div>
                    <div class="value">57,753</div>
                </div>
                <div class="svg-container">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
        ...
        <div class="supply-chain-item sc3 top-row grid-item-design">
            <div class="top">
                <div class="text">
            ...
            <div class="dashboard-analytics">
                <span>+3</span> more today
            </div>
        </div>
        <div class="supply-chain-item sc4 top-row grid-item-design">
            <div class="top">
                <div class="text">
        ...
        <div class="supply-chain-item sc5 order-requests-container grid-item-design">
            <span class="item-name">Order Requests</span>
            <div class="order-requests-list-container container_scrollbar_design">
                <ul class="order-requests-list">
                    <!-- Header Row -->
        ...
        <div class="supply-chain-item sc6 order-processes-container grid-item-design">
            <span class="item-name">Order Processes</span>
            <div class="order-processes-list-container container_scrollbar_design">
                <ul class="order-processes-list">
                    <!-- Header Row -->
        ...
        <div class="supply-chain-item sc7 chart-tab grid-item-design">
            <div class="svg-container">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
            ...
            <div class="text">Supplier Details</div>
        </div>
