...
<div class="inventory-grid">
        <div class="inventory-item title">Inventory Movements</div>
        <div class="inventory-item top-row im1">
            <div class="top">
                <div class="text">
        ...
        <div class="inventory-item top-row im2">
            <div class="top">
                <div class="text">
        ...
        <div class="inventory-item inventory-activities im3">
        ...
        <div class="inventory-item im6 chart-tab">
            <div class="svg-container">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
        ...
        <div class="inventory-item im7 chart-tab">
            <div class="svg-container">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
