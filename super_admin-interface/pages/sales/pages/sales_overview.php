...
<div class="sales-grid">
        <div class="sales-item title">Sales Overview</div>
        ...
        <div class="sales-item sm5 recent-orders-container">
            ...
            <div class="recent-orders-list-container container_scrollbar_design">
                <ul class="recent-orders-list">
                    <!-- Header Row -->
                    <li class="recent-orders-header">
                        <span class="recent-orders-header-product-id">Product ID</span>
                        <span class="recent-orders-header-quantity">Quantity</span>
                        <span class="recent-orders-header-sale">Sale</span>
                        <span class="recent-orders-header-status">Status</span>
                    </li>
                    <!-- Dynamic Data Rows -->
                </ul>
            </div>
        ...
        <div class="sales-item sm7 chart-tab">
            ...
            <div class="text">Create orders</div>
        </div>
